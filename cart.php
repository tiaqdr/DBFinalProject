...
?>
        ...
        <div class="d-flex mb-5">
          ...
          if($result_count>0){
            ...
            text-light'><a href='./user_area/checkout.php' class='text-light text-decoration-none'>Checkout</a></button>";
          }
          else{
            echo "<a <input type='submit' value=Continue Shopping class='bg-info px-3 py-2 
            border-0 mx-3' name='continue_shopping'>";
          }
